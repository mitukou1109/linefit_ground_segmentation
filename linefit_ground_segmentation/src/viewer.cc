...
Viewer::Viewer()
{
  ...
  viewer_.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 2.0f, "min_cloud");
  viewer_.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_COLOR, 1.0f, 0.0f, 0.0f, "ground_cloud");
...
void Viewer::visualize(const std::list<PointLine>& lines, const PointCloud::ConstPtr& min_cloud,
